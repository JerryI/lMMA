...
COND, EQUALS, DOT, EXPRESSION, POWER, SUB, SIN, COS, EXP, RULE, REPLACE, PART, DO, UNDEFINED, BREAK, RETURN, CONTINUE, LESSEQUAL, SQRT, Length};
//yess...
...
string EnumTypes[] =
{
   ...
   "Return", "Continue", "LessEqual", "Sqrt", "Length"
};
...
typedef struct definition{
    ...
    node* data;
    node* (*function)(node* itself, vector<node*> &args, definition* library);
    unsigned restore_id;
